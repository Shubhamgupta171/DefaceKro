...
const CYBER_HUB_URL = "https://d3lzcn6mbbadaf.cloudfront.net/media/details/ANI-20230814112752.jpg";
    ...
    <main className="main-content">
      <div className="banner">
        <h1 className="banner-title">
          <img src="https://thumbs.dreamstime.com/b/amazon-logo-amazon-logo-white-background-vector-format-avaliable-124289859.jpg" />
          Ministry of Defence
        </h1>
